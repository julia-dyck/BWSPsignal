...
namespace model_pgw_tte_lognormalprior_namespace {
...
static constexpr std::array<const char*, 39> locations_array__ =
  ...
  " (in 'string', line 60, column 2 to column 62)",
  " (in 'string', line 61, column 2 to column 68)",
  " (in 'string', line 62, column 2 to column 50)",
  " (in 'string', line 63, column 2 to column 47)",
  " (in 'string', line 64, column 2 to column 50)",
  " (in 'string', line 66, column 4 to column 49)",
  " (in 'string', line 65, column 24 to line 67, column 3)",
  " (in 'string', line 65, column 2 to line 67, column 3)",
  " (in 'string', line 69, column 4 to column 50)",
...
class model_pgw_tte_lognormalprior final : public model_base_crtp<model_pgw_tte_lognormalprior> {
private:
  int N_status_e;
  int N_status_c;
...
public:
  ~model_pgw_tte_lognormalprior() {}
  model_pgw_tte_lognormalprior(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_pgw_tte_lognormalprior_namespace::model_pgw_tte_lognormalprior";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  inline std::string model_name() const final {
    return "model_pgw_tte_lognormalprior";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_pgw_tte_lognormalprior_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      gamma = in__.template read_constrain_lb<local_scalar_t__,
                jacobian__>(0, lp__);
      {
        local_scalar_t__ t_mu = DUMMY_VAR__;
        current_statement__ = 4;
        t_mu = lognormal_expect_stdev_to_mu(t_expect, t_stdev, pstream__);
        local_scalar_t__ t_sigma = DUMMY_VAR__;
        current_statement__ = 5;
        t_sigma = lognormal_expect_stdev_to_sigma(t_expect, t_stdev,
                    pstream__);
        ...
        lp_accum__.add(stan::math::lognormal_lpdf<false>(theta, t_mu, t_sigma));
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_pgw_tte_lognormalprior_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_pgw_tte_lognormalprior_namespace::model_pgw_tte_lognormalprior;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_pgw_tte_lognormalprior_namespace::profiles__;
}
#endif
#endif
