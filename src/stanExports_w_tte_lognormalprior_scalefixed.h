...
namespace model_w_tte_lognormalprior_scalefixed_namespace {
...
static constexpr std::array<const char*, 25> locations_array__ =
  ...
  " (in 'string', line 43, column 2 to column 47)",
  " (in 'string', line 45, column 4 to column 49)",
  " (in 'string', line 44, column 24 to line 46, column 3)",
  " (in 'string', line 44, column 2 to line 46, column 3)",
  " (in 'string', line 48, column 4 to column 50)",
  " (in 'string', line 47, column 24 to line 49, column 3)",
  ...
  " (in 'string', line 27, column 20 to column 30)",
  " (in 'string', line 27, column 2 to column 35)",
  " (in 'string', line 28, column 20 to column 30)",
  ...
  " (in 'string', line 11, column 60 to line 13, column 3)",
  " (in 'string', line 18, column 2 to column 41)",
  " (in 'string', line 17, column 63 to line 19, column 3)"};
...
class model_w_tte_lognormalprior_scalefixed final : public model_base_crtp<model_w_tte_lognormalprior_scalefixed> {
private:
  int N_status_e;
  int N_status_c;
...
public:
  ~model_w_tte_lognormalprior_scalefixed() {}
  model_w_tte_lognormalprior_scalefixed(stan::io::var_context& context__,
    ...
    static constexpr const char* function__ =
      "model_w_tte_lognormalprior_scalefixed_namespace::model_w_tte_lognormalprior_scalefixed";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  inline std::string model_name() const final {
    return "model_w_tte_lognormalprior_scalefixed";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_w_tte_lognormalprior_scalefixed_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
        ...
        for (int i = 1; i <= N_status_e; ++i) {
          ...
          lp_accum__.add(stan::math::weibull_lpdf<false>(
                           stan::model::rvalue(te, "te",
                             stan::model::index_uni(i)), t_expect, nu));
        }
        ...
        for (int j = 1; j <= N_status_c; ++j) {
          ...
          lp_accum__.add(stan::math::weibull_lccdf(
                           stan::model::rvalue(tc, "tc",
                             stan::model::index_uni(j)), t_expect, nu));
        }
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_w_tte_lognormalprior_scalefixed_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"nu"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"nu\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"}]");
  }
...
using stan_model = model_w_tte_lognormalprior_scalefixed_namespace::model_w_tte_lognormalprior_scalefixed;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_w_tte_lognormalprior_scalefixed_namespace::profiles__;
}
#endif
#endif
